...
describe("Mouse Operations",()=>{
    ...
    it.only('Scrolling Page',()=>{
        ...
        cy.get(':nth-child(2) > tbody > :nth-child(95) > :nth-child(1) > img').scrollIntoView({duration:2000});
        cy.get(':nth-child(2) > tbody > :nth-child(95) > :nth-child(1) > img').should('be.visible')
    });
